    ...
    <section className="projects">
      ...
      <div className="projects-grid">
        ...
        >
          ...
          <p className="project-subtext">React | JavaScript | Node.js | PostgreSQL</p>
        ...
        >
          ...
          <p className="project-subtext">React | TypeScript | Node.js | MongoDB | AI</p>
        ...
        >
          ...
          <p className="project-subtext">React | JavaScript | Node.js | Backendless | Flowrunner | AI</p>
        ...
        >
          ...
          <p className="project-subtext">React | JavaScript | Node.js | Backendless | Flowrunner</p>
